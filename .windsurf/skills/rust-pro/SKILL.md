...
## Common Pitfalls
- Fighting the borrow checker instead of designing with ownership in mind
- Over-using unsafe code when safe alternatives exist
- Not documenting safety invariants for unsafe blocks
- Ignoring error handling with unwrap() everywhere
- Using blocking operations in async contexts
- Not leveraging the type system for compile-time correctness
- Cloning data unnecessarily instead of using references

## Best Practices
- Design APIs with ownership and borrowing in mind
...
- Write comprehensive tests including property-based tests with proptest