...
## When to Use
- Designing UI components, layouts, and visual systems
- Creating color schemes, typography systems, or animation patterns
- Making aesthetic decisions for web interfaces
- Reviewing or improving existing designs
- Working on user experience and visual hierarchy
- Deciding on design patterns for new features
...
**Color not specified?** Ask: "What color palette do you prefer? (blue/green/orange/neutral/other?)"

**Style not specified?** Ask: "What style are you going for? (minimal/bold/retro/futuristic/organic?)"

**Layout not specified?** Ask: "Do you have a layout preference? (single column/grid/asymmetric/full-width?)"
...
| **[code-review-checklist](../code-review-checklist/SKILL.md)** | After coding - Audit for accessibility, performance, and best practices |
...
3. AUDIT    → Run code-review-checklist review
4. FIX      → Address findings from audit
```

> **Next Step:** After coding, use `code-review-checklist` skill to audit your implementation for accessibility, focus states, animations, and performance issues.
...
## Common Pitfalls
- Using the same color palette for every project
- Defaulting to dark mode with neon glow
- Using purple/violet excessively (Purple Ban)
- Creating bento grids for simple landing pages
- Using mesh gradients and aurora effects as default
- Copying modern SaaS layouts without context
- Not asking user about style preferences
- Using rounded everything without contrast

## Best Practices
- ASK user about color, style, and layout preferences
- Read ux-psychology.md before starting any design
- Consider audience (Gen Z, Millennials, B2B, Luxury)
- Use constraint analysis (timeline, brand, tech, audience)
- Vary design radically between projects
- Apply UX psychology laws (Hick's, Fitts', Miller's)
- Use 60-30-10 color rule with intention
- Test accessibility (WCAG requirements)
